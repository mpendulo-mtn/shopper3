...
Visit http://localhost:3000/shopper3  in your browser to see your application running.
...
Your NestJS application is now running inside a Docker container and is accessible via http://localhost:3000/shopper3.
